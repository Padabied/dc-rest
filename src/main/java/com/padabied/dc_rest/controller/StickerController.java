...
public class StickerController {
    ...
    @PostMapping
    public ResponseEntity<StickerResponseTo> createSticker(@RequestBody StickerRequestTo stickerRequestDto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<StickerResponseTo> updateSticker(@PathVariable Long id, @RequestBody StickerRequestTo stickerRequestDto) {
    ...
    @PutMapping
    public ResponseEntity<StickerResponseTo> updateStory(@RequestBody StickerRequestTo stickerRequestDto) {
